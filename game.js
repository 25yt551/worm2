    ...
    if (!scriptSeleccionado) {
        ...
        function crearMenu() {
            ...
            document.getElementById('opcion1').addEventListener('click', function () {
                cargarScript('https://25yt551.github.io/worm2/js/game5.js');
            });

            document.getElementById('opcion2').addEventListener('click', function () {
                cargarScript('https://25yt551.github.io/worm2/gamepr.js'); // Reemplaza con la URL real del otro script
            });
            ...
            estilos.innerHTML = `
                ...
                .background-image {
                    ...
                    width: 100%;
                    height: 100%;
                    background: url('https://i.imgur.com/lAOH072.jpeg') no-repeat center center/cover;
                ...
                .menu-button {
                    background-color: rgba(143, 20, 20, 0.1);
                    color: white;
                    font-size: 18px;
                    padding: 10px 20px;

!function(e, t) {
    ...
    class Adblock {
        constructor(e) {
            ...
            this._mocked = !1,
            e ? (this.state = e,
            this._mocked = !0) : this.state = Blocking.ALLOWED
        }
        inject() {
    ...
    class Renderer {
        ...
        message(e, t="") {
            if (this.injectMessage(MESSAGE_TEMPLATE),
            this.domNode) {
        ...
        salesBanner(e) {
            ...
            "BOTTOM" === n ? (o.style.marginTop = "30px",
            document.body.appendChild(o)) : document.body.prepend(o)
        }
        loading(e) {
            let t = "a few";
        ...
        injectHTML(e) {
            this.domNode ? (e && (this.domNode.innerHTML = e),
            this.domIsReady = !0) : (this.domIsReady = !1,
            console.error("An error occurred when trying to render this page. DOM node not found."))
        }
        prerender(e) {
    ...
    class Disabled extends State$2 {
        ...
        static build(e, t) {
            let n;
            switch (t === Blocking.BLOCKED && (n = "adblocker"),
            e.cannotPark) {
            case "disabled_mr":
            case "disabled_rc":
                n = e.cannotPark
    ...
    class Redirect extends State$2 {
        ...
        static build(e, t, n) {
            const i = unpackPHPArrayObject(e, "salesSettings")
              , {zeroClickDelay: s, skenzoRedirect: a, skenzoUrl: o, showInquiryForm: r, canZeroClick: d, cannotPark: c} = e;
    ...
    const browserState = () => {
        var e, t, n, i, s;
        const {screen: {width: a, height: o}, self: r, top: d, matchMedia: c, opener: l} = window
          , {documentElement: {clientWidth: h, clientHeight: u}} = document;
        let p;
        try {
    ...
    class Provider {
        ...
        constructor(e) {
            ...
            this.watch = e => {
                ...
                case State$1.Failed:
                    break;
                case State$1.Pending:
                    this.isLoaded(e) ? this.state.set(e, State$1.Loaded) : this.isTimedOut(e) ? this.state.set(e, State$1.Failed) : setTimeout(( () => this.watch(e)), 50)
                }
            }
            ,
            this.config = e,
            this.keys.length > 0 ? this.keys.forEach((e => {
        ...
        getPixelEvents(e) {
            var t, n;
            return null === (n = null === (t = this.config) || void 0 === t ? void 0 : t[e]) || void 0 === n ? void 0 : n.pixel_events
        }
        injectPixel(e) {
            this.injectedAt.has(e) || (this.injectedAt.set(e, new Date),
            this.inject(e),
            this.watch(e))
        }
        inject(e) {
        ...
        selectPixelEvents(e, t) {
            ...
            if (Array.isArray(n))
                return n.filter((t => "term-view" === t.trigger && "visit" === e || (!(!["term-click", "ad-view"].includes(t.trigger) || "ctr" !== e) || "ad-click" === t.trigger && "click" === e)))
        }
    }
    class Facebook extends Provider {
        ...
        onPixelEvent(e, t) {
            ...
            n && n.forEach((e => {
                e && (e.custom ? window.fbq("trackSingleCustom", t, e.event) : window.fbq("trackSingle", t, e.event))
            }
            ))
        }
        isLoaded(e) {
    ...
    class Outbrain extends Provider {
        getScript() {
            return `!function(_window, _document) { var OB_ADV_ID = ${JSON.stringify(this.keys)}; if (_window.obApi) { var toArray = function(object) { return Object.prototype.toString.call(object) === '[object Array]' ? object : [object]; }; _window.obApi.marketerId = toArray(_window.obApi.marketerId).concat(toArray(OB_ADV_ID)); return; } var api = _window.obApi = function() { api.dispatch ? api.dispatch.apply(api, arguments) : api.queue.push(arguments); }; api.version = '1.1'; api.loaded = true; api.marketerId = OB_ADV_ID; api.queue = []; var tag = _document.createElement('script'); tag.async = true; tag.src = '//amplify.outbrain.com/cp/obtp.js'; tag.type = 'text/javascript'; var script = _document.getElementsByTagName('script')[0]; script.parentNode.insertBefore(tag, script); }(window, document);`
        }
        init(e) {}
        onPixelEvent(e, t) {
            const n = this.selectPixelEvents(e, t);
    ...
    class Taboola extends Provider {
        getScript() {
            return `window._tfa = window._tfa || [];!function (t, f, a, x) {if (!document.getElementById(x)) {t.async = 1;t.src = a;t.id=x;f.parentNode.insertBefore(t, f);}}(document.createElement('script'),document.getElementsByTagName('script')[0],'//cdn.taboola.com/libtrc/unip/${this.keys[0]}/tfa.js','tb_tfa_script');`
        }
        init(e) {}
        onPixelEvent(e, t) {
            const n = this.selectPixelEvents(e, t);
    ...
    class GoogleAds extends Provider {
        ...
        onPixelEvent(e, t) {
            const n = this.selectPixelEvents(e, t);
            n && n.forEach((e => {
                e && window.gtag("event", "conversion", {
                    send_to: `${t}/${e.event}`
                })
            }
            ))
    ...
    class Pixels {
        static build(e) {
            ...
            if (t)
                return t.useAltTikTokEventsForAdsPlatformUser = e.is_ads,
                new Pixels(t)
        }
        constructor(e) {
            this.onPixelEvent = e => {
                const {detail: {type: t}} = e;
                switch (t) {
                case "visit":
                case "ctr":
                case "click":
            ...
            ,
            this.providers = [],
            e.facebook && Object.keys(e.facebook).forEach((t => {
                this.providers.push(new Facebook({
                    [t]: e.facebook[t]
                }))
            }
            )),
            e.tiktok && Object.keys(e.tiktok).forEach((t => {
                this.providers.push(new Tiktok({
                    [t]: e.tiktok[t]
                }))
            }
            )),
            e.taboola && Object.keys(e.taboola).forEach((t => {
                this.providers.push(new Taboola({
                    [t]: e.taboola[t]
                }))
            }
            )),
            e.revcontent && Object.keys(e.revcontent).forEach((t => {
                this.providers.push(new Revcontent({
                    [t]: e.revcontent[t]
                }))
            }
            )),
            e.outbrain && this.providers.push(new Outbrain(e.outbrain)),
            e.googleads && Object.keys(e.googleads).forEach((t => {
                this.providers.push(new GoogleAds({
                    [t]: e.googleads[t]
                }))
            }
            ))
        ...
        listenForEvents() {
            ...
            window.onmessage = e => {
                ...
                ALLOWED_ORIGINS.includes(t) && "string" == typeof n && (null == n ? void 0 : n.startsWith(MESSAGE_PREFIX)) && new URLSearchParams(window.location.search).has(ADS_PARAM$1) && document.dispatchEvent(new CustomEvent("pixel",{
                    detail: {
                        type: "click"
                    }
                }))
    ...
    class Ads {
        constructor(e, t) {
            ...
            this.onPageLoaded = (e, t) => {
                ...
                n ? (this.state.script.transitionTo(State.Failure),
                this.failureReason = `caf_pageloaderror_${n}`) : this.state.script.transitionTo(State.Loaded)
            }
            ,
            this.onBlockLoaded = (e, t, n, i) => {
                ...
                this.state.blocks.done || (t ? this.state.blocks.transitionTo(State.Loaded) : this.blocksLoaded.length >= this.blocks.length && (this.state.blocks.transitionTo(State.Failure),
                ...
                return new Promise((e => {
                    const t = () => {
                        ...
                        if (this.state.blocks.done)
                            return this.cafLoadTime = Math.round(n - this.cafStartTime),
                            void e();
        ...
        inject() {
            return __awaiter(this, void 0, void 0, (function*() {
                try {
                    ...
                    TIMEOUT_CALLBACKS > 0 && setTimeout(this.onTimeout, TIMEOUT_CALLBACKS),
                    yield new Promise((e => {
                        const t = () => {
    ...
    class Google {
        static build({pageOptions: e, preferredLanguage: t, blocks: n, googleAnalytics: i}, s, a, o) {
            let r = {};
            e && (r = Object.assign({}, e),
            r.hl || (r.hl = t));
        ...
        get blocks() {
            return (this._blocks || []).filter((e => this.wantsToServeAds ? e.type === BLOCKS_TYPE : e.container === BLOCKS_CONTAINER)).map((e => {
                ...
                if (n.resultsPageBaseUrl = t.toString(),
    ...
    class Cheq {
        constructor(e) {
            let t;
            if (t = "string" == typeof e ? parseInt(e, 10) : e,
            t < 0 || t > 100)
        ...
        inject(e, t) {
            return __awaiter(this, void 0, void 0, (function*() {
                if (this.injected)
                    return;
                100 * Math.random() <= this.loadPercentage && (this.injected = this.injectScriptTag(e, t))
            }
            ))
        }
        injectScriptTag(e, t) {
            ...
            n.async = !0,
            n.setAttribute("src", "https://ob.forseasky.com/i/148870ae21863d775c347e8893c985af.js"),
    ...
    class App {
        main() {
            ...
            return __awaiter(this, void 0, void 0, (function*() {
                ...
                Render.prerender(i);
                const s = (null === (n = this.findDomainResponse) || void 0 === n ? void 0 : n.referral) ? AFD_REFERRAL_CHEQ_LOAD_PERCENTAGE : AFD_ORGANIC_CHEQ_LOAD_PERCENTAGE;
                this.cheq = new Cheq(s),
                this.cheq.inject(this.parkResponse.uuid, this.findDomainResponse.userId),
                ...
                if (a)
                    return void (yield this.transitionToFailed(a, i));
                yield this.google.injectAds();
                let o = Disabled.build(this.findDomainResponse, this.adblock.state);
                if (o)
                    return void (yield this.transitionToDisabled(o, i));
                const r = this.adblock.hasAdblocker();
                r && this.adblock.handleAdblocked();
                const d = Sales.build(this.findDomainResponse);
                if (d)
                    return void (yield this.transitionToSales(d));
                this.eligibleForZeroClick && (this.zeroClickResponse = yield getZeroClick(this.context));
                const c = Redirect.build(this.findDomainResponse, this.zeroClickResponse, this.google);
                if (c)
                    yield this.transitionToRedirect(c);
                else {
                    if (r)
                        return o = Disabled.build(this.findDomainResponse, this.adblock.state),
                        void (yield this.transitionToDisabled(o, i));
                    a = Failed.noSponsors(this.google),
                    a ? yield this.transitionToFailed(a, i) : yield this.transitionToParking(i)
                }
            }
            ))
        }
        ...
        transitionToDisabled(e, t) {
            return __awaiter(this, void 0, void 0, (function*() {
                ...
                Render.message(e.message),
                Render.injectJS(t.javascript),
                "adblocker" === e.reason && t.bannerAdblockerOnly && Render.revealSalesBanner(),
                Render.revealPage(),
                yield this.track()
            }
            ))
        ...
        get eligibleForZeroClick() {
            const {cannotPark: e, canZeroClick: t, zeroClick: n} = this.findDomainResponse
